...
class NewPoints:
    def __init__(self):
        self.__pileOrigin = [0,-290]
        self.__rad = 100
        self.__cPos = [0,0]
        self.__OneStack = 50
        self.__OneBigStack = 1000
        self.black = "#000000"
    ...
    def totalUpdateStackFull(self,move):
        t_xpos = self.__pileOrigin[0]+600-move
        t_ypos = self.__pileOrigin[1]-50
    ...
    def totalUpdate(self,points):
        t_xpos = self.__pileOrigin[0]+600
        t_ypos = self.__pileOrigin[1]-50
    ...
    # show of all the coins(big and small) earned at the end of a session/block
