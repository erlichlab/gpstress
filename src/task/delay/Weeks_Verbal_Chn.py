# jfkdjakf
# Verbal tasks with longer delays (in weeks)
#--------------import stuff----------------------------------------
...
#--------------------------Main Code--------------------------------
def WeeksVerbal_Chn(var,doo,myPoints,dbc,mouse,getName=True,sub_id=None,pre_points=0,gettrialn=0,pre_trials=0):
    ...
    var.weekVerbal = True # specify long verbal for specific functions
...
if __name__ == "__main__":
    WeeksVerbal_Chn(var,doo,myPoints,dbc,mouse) # run main function