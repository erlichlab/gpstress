...
def w_after_verbalCombined_nq(dbc,var,id,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay):
    dbc.execute('insert into sessions_end (sessid, subjid, sessiondate, endtime, treatment, sessionpay, trialpay,payrew,paydelay) values (%s, %s, %s, %s, %s, %s, %s, %s, %s)',\
                (id+1,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay)) 
...
def w_after_verbalCombined_dw(dbc,var,id,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay,session_pay2, trial_pay2,pay_num2,pay_delay2):
    dbc.execute('insert into sessions_end (sessid, subjid, sessiondate, endtime, treatment, sessionpay, trialpay,payrew,paydelay,sessionpay_w, trialpay_w,payrew_w,paydelay_w) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)',\
                (id+1,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay,session_pay2, trial_pay2,pay_num2,pay_delay2)) 
def w_after_verbalCombined_dw_Chn(dbc,var,id,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay,session_pay2, trial_pay2,pay_num2,pay_delay2,rate_ans, quest):
    dbc.execute('insert into sessions_end (sessid, subjid, sessiondate, endtime, treatment, sessionpay, trialpay,payrew,paydelay,sessionpay_w, trialpay_w,payrew_w,paydelay_w,moneyscarcity, timescarcity, hurry, questionnaire) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)',\
                (id+1,p_num, expDate, endt, expName, session_pay, trial_pay,pay_num,pay_delay,session_pay2, trial_pay2,pay_num2,pay_delay2,rate_ans[0], rate_ans[1], rate_ans[2], quest)) 