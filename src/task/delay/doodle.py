...
class Doodle:
    def __init__(self):
        ...
        self.instruction = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'Block Name',    font=u'Arial Monospaced',
            pos=[0, 0], height=30, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.chinese_instruction = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'',    font=u'Songti SC',
            pos=[0, 240], height=40, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        ...
        self.chinese_survey_instr = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'',    font=u'Songti SC',
            pos=[0, 0], height=20, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        #Doodle var for text choices 
        self.choice1 = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'',    font=u'Arial Monospaced',
            pos=[-240, 30], height=50, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.choice2 = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'',    font=u'Arial Monospaced',
            pos=[240, 30], height=50, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.choice1_Chn = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'',    font=u'Songti SC',
            pos=[-240, 30], height=50, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.choice2_Chn = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'',    font=u'Songti SC',
            pos=[240, 30], height=50, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.reminder = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'Reminder: Press \'a\' for the left choice and \'l\' for the right choice. Please do not press any other buttons.',    font=u'Arial',
            pos=[0, -240], height=20, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
        self.reminder_Chn = visual.TextStim(setup.mywin, units='pix', ori=0, name='Instructions',text=u'提示：请按下‘A’选择左侧选项，‘L’选择右侧选项，请不要误按其它按键。',    font=u'Songti SC',
            pos=[0, -240], height=20, wrapWidth=None,color=u'black', colorSpace='rgb', opacity=1,depth=-12.0,alignVert='center',alignHoriz='center')
