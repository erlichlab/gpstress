# Run this file for combined verbal experiment (shortverbal+longVerbal+shortVerbal+longVerbal) 
# Chinese Version
#-------------------imports--------------------------------------------------------------------
...
#---------------Main Function-------------------------------------
def verbal_odd_Chn(var,doo,mouse,myPoints,dbc):
    ...
    p_net,points_short1,trials_short1,trialsCorrect_short1 = Short_Verbal_Chn.ShortVerbal(var,doo,myPoints,dbc,mouse) # run short verbal session #1
    ...
    p_net,pick1,pay_delay1,pay_num1,trials_long1,points_long1 = Long_Verbal_Chn.LongVerbal(var,doo,myPoints,dbc,mouse,getName=False,sub_id=p_net,gettrialn=0) # run the first long verbal session and record the returned info
    ...
    fc.block_break_Chn(var,doo)  # show the break instruction to subject
    Short_Verbal_Chn.ShortVerbal(var,doo,myPoints,dbc,mouse,getName=False,sub_id=p_net,pre_points=points_short1,pre_trials=trials_short1,pre_trialsCorrect=trialsCorrect_short1) # run short verbal session #1
    fc.block_break_Chn(var,doo)  # show the break instruction to subject
...
if __name__ == "__main__":
    verbal_odd_Chn(var,doo,mouse,myPoints,dbc) # call main function
