...
#---------------Main Function-------------------------------------
def verbal_dw_odd(var,doo,mouse,myPoints,dbc):
    ...
    p_net,pick2,pay_delay2,pay_num2,trials_short1,points_short1 = Days_Verbal_Chn.DaysVerbal_Chn(var,doo,myPoints,dbc,mouse) # run short verbal session #1
    ...
    p_net,pick1,pay_delay1,pay_num1,trials_long1,points_long1 = Weeks_Verbal_Chn.WeeksVerbal_Chn(var,doo,myPoints,dbc,mouse,getName=False,sub_id=p_net) # run the first long verbal session and record the returned info
...
if __name__ == "__main__":
    verbal_dw_odd(var,doo,mouse,myPoints,dbc) # call main function
