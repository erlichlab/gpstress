...
fig5bc = function(data,x1){
  ...
  p1 <- ggbiplot(dataX.pca, ellipse=TRUE, groups=gr)+
    ...
    theme_bw()
  #ggsave(paste0('paste0('../../figs/subj_figs/fig5bu.pdf'),plot=p1, units = 'in', width = 4, height = 4)
  p2 <- ggbiplot(dataX.pca, choices = 2:3, ellipse=TRUE, groups=gr)+
    ...
    theme(text = element_text(size=15)) +
    theme_bw()
  #ggsave(paste0('paste0('../../figs/subj_figs/fig5bd.pdf'),plot=p2, units = 'in', width = 4, height = 4)
  cumpro <- cumsum(dataX.pca$sdev^2 / sum(dataX.pca$sdev^2))
  #pdf(file = "../../figs/subj_figs/fig5cu.pdf", width = 4, height = 3)
  ...
  #dev.off()
  #pdf(file = "../../figs/subj_figs/fig5cd.pdf", width = 4, height = 3)
